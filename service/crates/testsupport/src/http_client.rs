use anyhow::Result;
use lambda_models::{
    Alias, ConcurrencyConfig, CreateAliasRequest, CreateFunctionRequest, Function, InvokeResponse,
    PublishVersionRequest, UpdateAliasRequest, UpdateFunctionCodeRequest,
...
impl LambdaClient {
    ...
    pub async fn invoke(
        ...
        name: &str,
        payload: Value,
        invocation_type: Option<(&str, &str)>,
